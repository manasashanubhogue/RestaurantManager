...
urlpatterns = [
    ...
    path('restaurants/<int:restaurant_id>/',view=RestaurantDetailsAPI.as_view({'get': 'get_restaurant_details'})),
    ...
    path('restaurants/review/<int:restaurant_id>/',view=ReviewAPI.as_view({'post': 'add_update_review'}))
]
